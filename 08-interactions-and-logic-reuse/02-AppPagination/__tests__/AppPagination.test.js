...
const AppPagination = require(getSolutionPath('components/AppPagination.vue'))
  .default;

describe('interactions-and-logic-reuse/AppPagination', () => {
  describe('AppPagination', () => {
    ...
    function testPageContentWithLetterPerPage(expectedStr) {
      ...
      expect(
        itemWrappers.every((item, i) =>
          item.text().includes(`"${expectedStr[i]}"`),
        ),
      ).toBe(true);
    }
